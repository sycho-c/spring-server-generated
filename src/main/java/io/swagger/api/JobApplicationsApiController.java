...
public class JobApplicationsApiController implements JobApplicationsApi {
    ...
    public ResponseEntity<JobApplication> jobApplicationsIdPut(@Parameter(in = ParameterIn.PATH, description = "", required=true, schema=@Schema()) @PathVariable("id") Integer id
